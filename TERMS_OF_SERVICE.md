...
Welcome to Habibi Swipe ("we," "our," or "us"). These Terms of Service ("Terms") govern your access to and use of the Habibi Swipe mobile application (the "App") and related services (collectively, the "Service").

By downloading, installing, accessing, or using the App, you agree to be bound by these Terms. If you do not agree to these Terms, you may not use the Service.

## 2. Eligibility

**Age Requirement:**
- You must be at least 18 years old to use Habibi Swipe
...
**Prohibited Users:**
- You may not use the Service if you have been previously banned or removed from Habibi Swipe
- You may not use the Service if you are prohibited from doing so under applicable laws

## 3. Description of Service

Habibi Swipe is a dating and social networking mobile application that allows users to:
- Create profiles with photos and personal information
- Discover and connect with other users
- Send and receive messages with matched users
- Send compliments to other users
...
- You may sign up using your email address or Google account
...
- Post, upload, or transmit any content that is:
  ...
  - Discriminatory or hateful based on race, religion, gender, sexual orientation, or other protected characteristics
...
- Use the Service to recruit for multi-level marketing or similar schemes
...
- Misrepresent your age, identity, or personal information

## 6. User Content

**Your Content:**
- You retain ownership of content you post, upload, or transmit through the Service
- By posting content, you grant us a worldwide, non-exclusive, royalty-free license to use, display, and distribute your content for the purpose of operating the Service

**Content Standards:**
- You are solely responsible for all content you post
- Content must comply with these Terms and applicable laws
- We reserve the right to remove any content that violates these Terms

**Content Moderation:**
- We may review, edit, or remove content at our discretion
- We are not obligated to monitor all content but reserve the right to do so
- We may use automated systems to detect and remove prohibited content
...
**Premium Features:**
- Habibi Swipe offers premium subscription features ("Habibi Swipe Pro")
...
- We follow the refund policies of the respective app stores
- Refunds are not guaranteed and are subject to app store policies

**Price Changes:**
- We reserve the right to change subscription prices
- Price changes will be communicated to you in advance
- Existing subscriptions will continue at the current price until renewal

## 8. Intellectual Property

**Our Rights:**
- The Service, including all content, features, and functionality, is owned by Habibi Swipe
- All trademarks, logos, and brand names are our property
- The App and its original content are protected by copyright, trademark, and other intellectual property laws

**Your Rights:**
- You retain ownership of content you create and post
- You grant us a license to use your content as described in Section 6
...
- We are not responsible for any downtime, outages, or technical issues
...
- We recommend exercising caution when meeting people in person
...
You agree to indemnify, defend, and hold harmless Habibi Swipe, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
...
- Any disputes arising from these Terms or the Service shall be resolved through:
  ...
  2. If negotiation fails, through binding arbitration in accordance with [Arbitration Rules]
...
Your continued use of the Service after such changes constitutes acceptance of the updated Terms. If you do not agree to the changes, you must stop using the Service.

## 16. Miscellaneous

**Entire Agreement:**
- These Terms, together with our Privacy Policy, constitute the entire agreement between you and Habibi Swipe
...
**Assignment:**
- You may not assign or transfer these Terms or your account without our consent
